...
<body>
    ...
    <header>
          ...
          <div class="container">
            ...
            <a href="/index.php" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
              ...
              <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                ...
                <li>
                  <a href="<?$allproductspage?>" class="nav-link text-white" id="products" >
      ...
      <!-- ---------------------------------------------header--------------------------------------------------------- -->
       <!-- ---------------------------------------------ProductMacbookMain--------------------------------------------------------- -->
<main>
<section class="h1Cate"><h1>All Products</h1></section>
  <div class="album py-5 bg-light">
    ...
    <span></span>
      ...
      <div class="container">
        ...
        <!-- ---------------------------------------------footer--------------------------------------------------------- -->
        <script type="module" src="./Js/allproductspage.js"></script>
